...
public class NettyNativeCompressionEncoder extends MessageToByteEncoder<ByteBuf> {

    private int threshold;
    private final VelocityCompressor compressor;

    public NettyNativeCompressionEncoder(int threshold, VelocityCompressor compressor) {
    ...
    protected ByteBuf allocateBuffer(ChannelHandlerContext ctx, ByteBuf msg, boolean preferDirect)
        ...
        if (uncompressed < threshold) {
            ...
            return NettyFrameEncoder.IS_JAVA_CIPHER
